...
-   ### User stories
    ...
    -   #### Returning Visitor Goals
        ...
        3. As a Returning Visitor, I want to easily find the books that the club are currently reading.

    -   #### Frequent User Goals
        1. As a Frequent User, I want to check to see if the locations for meetings have changed.
        2. As a Frequent User, I want to check to see if there are any new books to read.
